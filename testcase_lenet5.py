...
weights='./models/lenet5/original_model.caffemodel'
solver_path='./models/lenet5/lenet_solver_fortest.prototxt'
es_method='ncs'
# cpu/gpu
caffe.set_mode_gpu()
caffe.set_device(0)
...
#save final model
solver.net.save('./models/lenet5/pruned_lenet5.caffemodel')
