...
weights='./models/lenet30001000/original_model.caffemodel'
solver_path='./models/lenet30001000/lenet_solver_fortest.prototxt'
es_method='ncs'
# cpu/gpu
caffe.set_mode_gpu()
caffe.set_device(0)
...
solver.net.save('./models/lenet30001000/pruned_lenet30001000.caffemodel')
